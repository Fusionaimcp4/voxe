...
export const CRM_PROVIDERS: Record<CRMProvider, CRMProviderInfo> = {
  ...
  FRONT: {
    id: 'FRONT',
    name: 'Front',
    description: 'Customer operations platform that unifies teams around the customer',
    icon: '/front.png',
  ...
  ZENDESK: {
    id: 'ZENDESK',
    name: 'Zendesk',
    description: 'Customer service platform and support ticket system',
    icon: '/zendesk.svg',
  ...
  FRONT: [
    {
      ...
      type: 'password',
      placeholder: 'Enter your API key',
      helpText: 'Your Front API key (found in Settings > API)',
      validation: {
        required: true,
        minLength: 20,
      },
    ...
    {
      name: 'baseUrl',
      label: 'Front Base URL',
      type: 'url',
      placeholder: 'https://api2.frontapp.com',
      helpText: 'Front API base URL (usually https://api2.frontapp.com)',
      validation: {
        required: true,
        pattern: /^https?:\/\/.+/,
      },
  ...
  ZENDESK: [
    {
      ...
      helpText: 'Your Zendesk subdomain (from yourcompany.zendesk.com)',
      validation: {
        required: true,
        pattern: /^[a-z0-9-]+$/,
      },
    ...
    },
    {
      ...
      type: 'email',
      placeholder: 'user@company.com',
      helpText: 'Your Zendesk admin email',
      validation: {
        required: true,
      },
      sensitive: false,
    },
    {
      ...
      type: 'password',
      placeholder: 'Enter your API token',
      helpText: 'Your Zendesk API token (found in Settings > API)',
      validation: {
        required: true,
        minLength: 20,
      },
